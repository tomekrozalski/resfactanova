...
{#await $page.data.streamed.randomArticle}
	<div
		class="relative mb-10 flex justify-center rounded-l-lg border
		border-gray-800 bg-gray-900 p-4 text-sm text-gray-200"
		role="status"
	>
		<svg
			aria-hidden="true"
			class="h-8 w-8 animate-spin fill-blue text-gray-600"
			viewBox="0 0 100 101"
			fill="none"
